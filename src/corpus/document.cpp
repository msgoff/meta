...
const class_label& document::label() const { return label_; }
...
void document::encoding(const std::string& encoding) { encoding_ = encoding; }
...
const std::string& document::encoding() const { return encoding_; }

doc_id document::id() const { return d_id_; }

bool document::contains_content() const { return static_cast<bool>(content_); }

void document::label(class_label label) { label_ = label; }

const std::vector<metadata::field>& document::mdata() const { return mdata_; }
