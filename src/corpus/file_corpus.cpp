  ...
  while (std::getline(input, line)) {
    ...
    if (space != std::string::npos) {
      ...
      throw corpus_exception{
          "document list needs class label prefix "
...
uint64_t file_corpus::size() const { return docs_.size(); }
